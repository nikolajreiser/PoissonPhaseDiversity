...
fs = 1100
ob = cell_multi(fs*2, 1600, (30, 60), e = .7, overlap = .05)

ob_64 = ob[fs-64:fs+64, fs-64:fs+64]
ob_128 = ob[fs-128:fs+128, fs-128:fs+128]
ob_256 = ob[fs-256:fs+256, fs-256:fs+256]
ob_512 = ob[fs-512:fs+512, fs-512:fs+512]
ob_1024 = ob[fs-1024:fs+1024, fs-1024:fs+1024]
...
save_data('sweep_imsize_crop', errs_pn, errs_pd, errs_gn, errs_gd, time_pn, time_pd, time_gn, time_gd)